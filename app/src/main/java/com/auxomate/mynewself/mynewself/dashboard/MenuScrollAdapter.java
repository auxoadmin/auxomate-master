...
public class MenuScrollAdapter extends RecyclerView.Adapter<MenuScrollAdapter.ViewHolder>{
    Context context;
    ...
    public MenuScrollAdapter(Context context, ArrayList<String> list, ArrayList<Integer> imagesList) {
        this.context = context;
        this.menus = list;
        values = new ArrayList<>();
        itemCount = AuxoUtils.getViewItemsCount(context);
