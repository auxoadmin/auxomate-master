...
public class RecordDialog extends DialogFragment {
    ...
    public void setPositiveButton(String strPositiveButtonText, RecordDialog.ClickListener onClickListener) {
        ...
        getActivity().runOnUiThread(new Runnable() {
            ...
            public void run() {
                if(STATE_BUTTON.equals("RECORD")) {
                    ...
                    _timerView.setText(RecordUtils.formatSeconds(recorderSecondsElapsed));
                } else if(STATE_BUTTON.equals("PLAY")){
                    playerSecondsElapsed++;
                    _timerView.setText(RecordUtils.formatSeconds(playerSecondsElapsed));
                }
            }
        });
    }
